...
import 'package:animeworld/common/extensions/extensions.dart';
...
import 'package:animeworld/views/similar_anime_view.dart';
import 'package:animeworld/widgets/info_text.dart';
import 'package:animeworld/widgets/ios_back_button.dart';
import 'package:animeworld/widgets/networkimageview.dart';
import 'package:animeworld/widgets/readmore_text.dart';
  ...
  Widget _buildAnimeTitle({
    ...
    required String englishName,
      ...
      BlocBuilder<AnimeTitleLanguageCubit, bool>(builder: (context, state) {
        ...
        return Text(isEnglish ? englishName : name,
            style: TextStyle(
              fontSize: 20,
